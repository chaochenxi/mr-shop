...
public class SpecParamDTO {
    ...
    @NotNull(message = "是否是数字类型不能为空" , groups = {MingruiOperation.Update.class,MingruiOperation.Add.class})
    ...
    @NotNull(message = "是否用于搜索过滤不能为空" , groups = {MingruiOperation.Update.class,MingruiOperation.Add.class})
